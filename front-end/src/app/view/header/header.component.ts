  ...
  template: `
    <header class="flex justify-between border-b border-gray-700 p-2">
        ...
        <div #avatar (click)="onAvatarClick($event, avatar)"
             class="bg-contain relative w-9 h-9 border bg-sky-500 border-gray-700 cursor-pointer rounded-full hover:shadow-lg hover:shadow-cyan-900 flex justify-center items-center text-white font-bold"
